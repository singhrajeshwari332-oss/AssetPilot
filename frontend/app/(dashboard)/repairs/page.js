        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-40">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="ALL" className="text-xs">All Repairs</SelectItem>
                <SelectItem value="OPEN" className="text-xs">In Progress (Open)</SelectItem>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="hidden md:table-cell">Dispatched Date</TableHead>
              ...
              repairs.map((rep) => (
                <TableRow key={rep.id} className="hover:bg-muted/40 transition-colors">
                  ...
                  <TableCell className="text-xs text-muted-foreground max-w-xs">
                    <p className="font-medium text-foreground">{rep.issue}</p>
                    {rep.resolutionNotes && (
        ...
        <div className="flex items-center justify-between border-t px-4 py-3 text-xs text-muted-foreground bg-card">
          <div>
            ...
            <span className="font-medium text-foreground">
              {repairs.length === 0 ? 0 : (page - 1) * pagination.limit + 1}
            </span>{" "}
            to{" "}
            <span className="font-medium text-foreground">
              {Math.min(page * pagination.limit, pagination.total)}
            </span>{" "}
            of <span className="font-medium text-foreground">{pagination.total}</span> tickets
          </div>
